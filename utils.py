    ...
    def load_dataset(data_path,label_path,pad_size,label_dic,tokenizer):
        ...
        with open(data_path, 'r', encoding='utf-8') as df:
            with open(label_path, 'r', encoding='utf-8') as lf:
                train_data=df.readlines()[:10]
                train_label=lf.readlines()[:10]
                for word , label in zip(train_data,train_label):
                    ...
                    feature = InputFeatures(input_id=input_ids,label_id=label_ids,input_mask=input_mask,output_mask=output_mask)
